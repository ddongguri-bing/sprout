...
export default function SearchBar() {
  ...
  return (
    <form onSubmit={handleSubmit} className="relative mb-[30px]">
      ...
      <input
        id="search"
        className="w-full border rounded-[8px] border-main pr-[8px] pl-[30px] py-[8px] placeholder:text-sm focus:outline-none placeholder:text-gray bg-white dark:bg-black dark:text-white"
